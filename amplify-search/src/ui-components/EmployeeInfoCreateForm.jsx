...
import { createEmployeeInfo } from "../graphql/mutations";
const client = generateClient();
export default function EmployeeInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setWorkingyears(initialValues.workingyears);
    setJobtitle(initialValues.jobtitle);
    setMore(initialValues.more);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createEmployeeInfo.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "EmployeeInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Firstname"
